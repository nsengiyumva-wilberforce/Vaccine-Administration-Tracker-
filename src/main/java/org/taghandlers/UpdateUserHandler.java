 ...
 * @author USER
 */
public class UpdateUserHandler extends SimpleTagSupport {
    private String u, f, l, p, h, e, r, uid;
    ...
    public void doTag() throws JspException {
        ...
        PreparedStatement ps = con.prepareStatement("update newusers set username=?, first_name=?, last_name=?, password=?, healthcentre=?, email=?, role=? where username=?");
		ps.setString(1, getU());
		ps.setString(2, getF());
		ps.setString(3, getL());
                ps.setString(4, getP());
